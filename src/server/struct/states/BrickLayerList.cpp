...
void BrickLayerList::getNextSrcBrick(Robot* robot, Grid* grid, int &srcBrickLayerIndex)
{
	// Searching by O(N)
...
Brick* BrickLayerList::getNextDstBrick(Robot* robot, Grid* grid, int &dstBrickLayerIndex)
{
	// Searching by O(N)
	// Considering LayerList & Grid
	Brick* result = NULL;
